...
export const NFL_2026_FIRST_ROUND: MockDraftPick[] = [
  ...
  { pick: 7,  teamAbbr: 'WAS', firstName: 'Sonny',    lastName: 'Styles',           position: 'LB', college: 'Ohio State',    ovrBase: 75, potential: 86, blurb: 'Positionless defender who can play safety, linebacker, or nickel with equal effectiveness.' },
