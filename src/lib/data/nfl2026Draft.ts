...
export const NFL_2026_FIRST_ROUND: MockDraftPick[] = [
  ...
  { pick: 16, teamAbbr: 'NYJ', firstName: 'Ty',       lastName: 'Simpson',          position: 'QB', college: 'Alabama',       ovrBase: 70, potential: 85, blurb: 'Dual-threat quarterback with a cannon arm and exceptional athleticism.' },
