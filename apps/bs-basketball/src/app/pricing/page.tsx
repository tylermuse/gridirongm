...
const PREMIUM_FEATURES = [
  ...
  'Premium unlocks BS Football too — one sub, both sports',
  'Cancel anytime — Stripe Customer Portal',
];

const FREE_FEATURES = [
  'Full 82-game season simulation',
  'Draft, lottery, free agency, trades',
  'All stats, standings, league history',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-black mb-2">
            <span style={{ color: 'var(--accent)' }}>BS</span> Hoops Premium
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          {/* Premium tier */}
          <div
            className="relative rounded-2xl border-2 bg-white p-8 flex flex-col shadow-lg"
          ...
          >
            ...
            {isComplimentaryPremium ? (
              ...
              <button
                ...
                className="w-full py-3 rounded-xl text-white text-sm font-bold hover:brightness-110 transition disabled:opacity-60"
                style={{ background: 'var(--accent)' }}
              >
